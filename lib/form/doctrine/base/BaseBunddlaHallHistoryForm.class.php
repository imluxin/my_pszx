...
/**
 * BunddlaHallHistory form base class.
 *
 * @method BunddlaHallHistory getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseBunddlaHallHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'         => new sfWidgetFormInputHidden(),
      'bh_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('BunddlaHall'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'bh_id'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('BunddlaHall'))),
    ...
    $this->widgetSchema->setNameFormat('bunddla_hall_history[%s]');
