...
/**
 * TempleHistory filter form base class.
 *
 ...
 */
abstract class BaseTempleHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      't_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Temple'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      't_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Temple'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('temple_history_filters[%s]');
