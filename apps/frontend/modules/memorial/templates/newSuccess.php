...
<div class="side fl"><?php include_partial('memorial/user_info', array('myuser'=>$myuser))?>
</div>
<div class="main fr">
<div class="cont">
<h3 class="subTitle">建纪念馆</h3>
<div class="buildForm fix-img-160"><?php include_partial('memorial/form', array('form'=>$form))?>
</div>
</div>
</div>
</div>
